...
export const GAME_THEMES: GameTheme[] = [
  ...
  //   characterImage: formatPath('giaicuucongchua/character_images.png'),
  //   destinationName: 'Lâu Đài Hoàng Gia',
  //   destinationImage: formatPath('giaicuucongchua/destination_images.png'),
  //   stepName: 'Tầng tháp',
  //   stepImage: formatPath('giaicuucongchua/step_images.png'),
